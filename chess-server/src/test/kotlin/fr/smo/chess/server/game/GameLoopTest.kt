...
import fr.smo.chess.server.ai.NegamaxAIPlayer
import fr.smo.chess.server.fixtures.RandomAIPlayer
...
internal class GameLoopTest {
    ...
    private fun assertThatSumOfCaptureAndRemainingPieceIs32(gameState: GameState) {
        ...
        ) isEqualTo GameVariants.createStandardGame().chessboard.piecesOnBoard.size
    }
}