...
class PerftTest {
    ...
    fun `should compare real world perft result with this engine perft result`(
        name: String,
        fen: String,
        depth: Int,
    ...
    companion object {
        ...
        fun providePerftData(): Stream<Arguments> {
            val kiwipetePosition =
                "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1" // https://www.chessprogramming.org/Perft_Results#Position_2
            val position3 =
